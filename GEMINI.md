...
A suite of Gemini CLI subagents for automated data analysis workflows. Transform raw CSV/Excel data into clean datasets, statistical insights, interactive visualizations, and executive-ready reports.
...
Agent prompts are in `./.gemini/agents/`:
- `.gemini/agents/data-cleaner.md`
- `.gemini/agents/data-analyzer.md`
- `.gemini/agents/data-visualizer.md`
- `.gemini/agents/report-writer.md`
- `.gemini/agents/exec-summarizer.md`
- `.gemini/agents/full-analysis.md` (orchestrator)
...
```
data-analysis-agent-suite/
├── .gemini/agents/          # Agent prompt definitions (markdown with YAML frontmatter)
